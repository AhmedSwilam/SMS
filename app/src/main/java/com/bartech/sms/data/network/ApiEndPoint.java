...
public final class ApiEndPoint {
    ...
    public static final String ENDPOINT_REQUEST_COUNT = "http://46.105.99.135:85/api/ManageEmployeeApi/GetEmployeeRequestsCount";
    public static final String ENDPOINT_REQUEST_LIST = "http://46.105.99.135:85/api/ManageEmployeeApi/GetEmployeeRequestsInboxList";

    public static final String ENDPOINT_VISITS_COUNT = "http://46.105.99.135:85/api/ManageEmployeeApi/GetEmployeeVisitsCount";
    public static final String ENDPOINT_VISITS_LIST = "http://46.105.99.135:85/api/ManageEmployeeApi/GetEmployeeVisitsList";
    private ApiEndPoint() {

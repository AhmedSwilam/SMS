...
public interface ApiHelper {
    ...
    Single<SmsRequestCountResponse> doServerSmsRequestCount(SmsRequestsCountRequest.serverSmsRequestCountRequest smsRequestCountRequest);

    Single<SmsRequestsListResponse> doServerRequestsList(SmsRequestsCountRequest.serverSmsRequestCountRequest smsRequestCountRequest);

    Single<SmsVisitsCountResponse> doServerSmsVisitsCount(SmsVisitsCountRequest.ServerSmsVisitsCountRequest smsVisitsCountRequest);

    Single<SmsVisitsListResponse> doServerSmsVisitsList(SmsRequestsCountRequest.serverSmsRequestCountRequest smsRequestCountRequest);
